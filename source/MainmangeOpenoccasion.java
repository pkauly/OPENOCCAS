...
public class MainmanageOpenoccasion
...
public static void main(String[] args)
	{
		manageWorkevent mwoevt = new manageWorkevent();
		...
		workevent woevt = mwoevt.getWorkeventByID("19");
		wopintf.setWorkevent(woevt.getcurrentWorkevent());
